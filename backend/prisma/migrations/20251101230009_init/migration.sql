-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'MAYOR', 'VIEWER');
...
-- AddForeignKey
ALTER TABLE "Note" ADD CONSTRAINT "Note_cityId_fkey" FOREIGN KEY ("cityId") REFERENCES "City"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
